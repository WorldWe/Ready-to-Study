...
<body>
	...
	<header>
       ...
       <a href="{{url('accueil')}}"><img src="images/ss.gif"></a>
           ...
           <a class="navbar-brand" href="{{url('accueil')}}" style="position:relative;margin-left: 4%;">Home</a>
   ...
   <a class="navbar-brand" href="{{url('sinin')}}" style="position:relative;margin-right:50px;margin-left:100px;">login</a>
   <a class="navbar-brand" href="{{url('reg')}}" target="black" style="position:relative;margin-right:50%;">register</a>
