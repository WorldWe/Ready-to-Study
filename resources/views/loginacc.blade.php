...
<div class="card" style="width: 18rem;position:relative;margin-left:1%;">
  ...
  <div class="card-body">
   <h5 class="card-title" style="color:black;">Data analytic</h5><br>
    <p class="card-text">cxxvsh fjgjfj kdfdhf dfdgf ldfdlgj ggdsd khfdkfh lkf kgfjdghjfh kfhvkjdfhv jdhgdjg .</p>
    <a href="{{url('loginsec')}}" class="btn btn-primary"  id="mous" target="black">See more</a>
  </div>
</div>
<br>
<br>
...
<div class="card" style="width: 18rem;position:relative;margin-left:1%;margin-left:26%;top:-418px;">
...
<div class="card" style="width: 18rem;position:relative;margin-left:1%;top:-418px;">
